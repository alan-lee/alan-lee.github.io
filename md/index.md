...
1. [Linear Regression](index.html?md=linear_regression.md)

2. [Softmax Regression](index.html?md=softmax_regression.md)

3. [Gaussian Discriminant Analysis](index.html?md=GDA.md)

4. [Native Bayes](index.html?md=native_bayes.md)

5. [Neural Network](index.html?md=neural_network.md)
...
10. [Clustering Analysis](index.html?md=clustering_analysis.md)
